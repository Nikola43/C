...
void ejemplo1(void)
{
    ...
    pa = &a; /** almaceno en p la dir de memoria de la variable a */
    printf("\nchar a: %i\n", *pa); /** ¡muestra el valor –1, en vez de 255! */

    unsigned char b=255; /** 255 en binario es 11111111 (8 bits) */
    unsigned char *pb; /** p es un puntero a un signed char (por defecto) */
    pb = &a; /** almaceno en p la dir de memoria de la variable a */
