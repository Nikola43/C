...
int main()
{
    ...
    fp = fopen("PIEZAS.DAT", "w");

    printf("Introduzca el nombre, la cantidad y el precio por pieza: ");
    scanf("%s %d %f", nombre_pieza, &cantidad, &precio_unidad);

    fprintf(fp, "%s %d %f", nombre_pieza, cantidad, precio_unidad);
